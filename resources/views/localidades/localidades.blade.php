...
<div class="container-fluid" >
		...
		<div class="row" style="padding-left: 100px;">
			<form class="form-inline">			 
				<div class="form-group mx-sm-1 mb-1">
			  	...
			  	<div class="form-group mx-sm-1 mb-1">
			   	 	<label for="inputPassword2" class="sr-only">Localidad</label>
			    	<input type="text" class="form-control"  id="localidadNew" placeholder="Localidad">
			  	</div>
			  	<div class="form-group mx-sm-3 mb-2">
			   	 	<div id="combobox">
		  			</div>	
			  	</div>
			  	<button type="button" onclick="guardarLocalidad()" class="btn btn-primary mb-2">Guardar</button>
			</form>			
		</div>	
		<div class="row" style="padding-left: 100px;">
			<form class="form-inline">
				<div class="form-group mx-sm-3 mb-2">
			      	<div id="errorCodigoNew"></div>
			  	</div>		
			  	<div class="form-group mx-sm-3 mb-2">
 ...
 <script >
 	...
 	function guardarLocalidad(){
		...
		var localidad = document.getElementById('localidadNew').value;
		var comuna_id  = $('#combobox option:selected').val();
		ajaxNew(codigo,localidad,comuna_id);
 	}

 	function ajaxNew(codigo,localidad,comuna_id){
		var data = {
			'codigo': codigo,
			'nombre' : localidad,
			'comuna_id' : comuna_id,
